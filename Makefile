...
install:
	...
	7z x -o$(DESTDIR)/opt/hashstack/programs/ cudaHashcat-1.36.7z
	mv $(DESTDIR)/opt/hashstack/programs/cudaHashcat-1.36 $(DESTDIR)/opt/hashstack/programs/cudaHashcat
